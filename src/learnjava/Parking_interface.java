 ...
 * @author mico5
 */
public class Parking_interface extends javax.swing.JFrame {

    /**
     * Creates new form Parking
     */
    public Parking_interface() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Your Username or Phone");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        forget_password_interface fg = new forget_password_interface();
        fg.setVisible(true);
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Parking_interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Parking_interface().setVisible(true);
            }
        });
    }
